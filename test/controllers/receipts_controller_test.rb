...
class ReceiptsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create receipt" do
    assert_difference("Receipt.count") do
      post receipts_url, params: { receipt: { shop_id: @receipt.shop_id, shopped_at: @receipt.shopped_at } }
    end
  ...
  test "should update receipt" do
    patch receipt_url(@receipt), params: { receipt: { shop_id: @receipt.shop_id, shopped_at: @receipt.shopped_at } }
